...
(function(targetenv = globalenv()) {
        ...
        get_basedir <- function() {
                ...
                if (length(match) > 0) {
                        ...
                        srcdir = dirname(normalizePath(sys.frames()[[1]]$ofile))
                }
        ...
        load_module = function(module_name) {
                ...
                load.env = new.env(parent=targetenv)
        ...
        targetenv$require.r = function(module_name) {
        ...
        targetenv$require.r.config = function(...) {
